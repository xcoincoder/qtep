...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xcoincoder/gitian.sigs.git'])
    if not os.path.isdir('qtum-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xcoincoder/qtum-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('qtum'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xcoincoder/qtum.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/xcoincoder/qtum', help='Specify the URL of the repository. Default is %(default)s')
