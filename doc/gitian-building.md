...
git clone https://github.com/xcoincoder/gitian.sigs.git
```
...
cd /some/root/path/
git clone https://github.com/xcoincoder/qtum-detached-sigs.git
...
[xcoincoder/gitian.sigs](https://github.com/xcoincoder/gitian.sigs/) repository, or if that's not possible create a pull
