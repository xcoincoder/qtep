...
public:
    ...
    void setQtepTokenExec(QtepTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strQtepAddress, std::string& strHash160);
    static bool ToQtepAddress(const std::string& strHash160, std::string& strQtepAddress);
...
private:
    ...
    QtepToken(QtepToken const&);
    QtepToken& operator=(QtepToken const&);
