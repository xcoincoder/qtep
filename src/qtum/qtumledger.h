...
/**
 * @brief The QtepLedger class Communicate with the qtep ledger
 */
class QtepLedger {
    
public:
    /**
     * @brief QtepLedger Constructor
     */
    QtepLedger();

    /**
     * @brief ~QtepLedger Destructor
     */
    virtual ~QtepLedger();
...
private:
    QtepLedger(const QtepLedger&);
    QtepLedger& operator=(const QtepLedger&);
    QtepLedgerPriv* d;
};
#endif
