...
from test_framework.qtepconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        common_address = convert_btc_address_to_qtep("msf4WtN1YQKXvNtvdFYt9JBnUD2FB41kjr")
        node.sendmany(
